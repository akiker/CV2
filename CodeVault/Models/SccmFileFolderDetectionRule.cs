...
{
    public class SccmFileFolderDetectionRule : SccmRule
    {
        [Required]
        ...
        [Display(Name = "FileOrFolderRulePropertyType",
            Description = "The property value the rule is set to (ex: Version)")]
        public FileOrFolderRulePropertyType FileOrFolderRuleProperty { get; set; }

        [EnumDataType(typeof (FileOrFolderRuleOperatorType))]
        [Display(Name = "FileOrFOlderRuleOperatorType",
            Description = "The operator value the rule is set to (ex: Equals")]
        public FileOrFolderRuleOperatorType FileOrFolderRuleOperator { get; set; }

        [Display(Name = "FileOrFolderRuleValue",
            Description = "Holds the string value that the Property must match to (ex: 2.0)",
            Prompt = "Enter the Value that the rules must match to")]
